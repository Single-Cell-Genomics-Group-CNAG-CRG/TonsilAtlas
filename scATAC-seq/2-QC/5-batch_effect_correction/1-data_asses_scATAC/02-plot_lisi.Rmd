...
```{r}
# Paths
path_to_lisi_scores <- here::here("scATAC-seq/2-QC/5-batch_effect_correction/1-data_asses_scATAC/tmp/lisi_scores.rds")
path_to_confounders_df <- here::here("scATAC-seq/2-QC/5-batch_effect_correction/1-data_asses_scATAC/tmp/confounders_df.rds")
```
...
plot_titles <- c("Library", "Sex", "Age group", "Technique", "Hospital")
