...
```{r}
# Paths
path_to_lisi_scores <- here::here("scATAC-seq/2-QC/5-batch_effect_correction/2-data_integration_multiome/tmp/lisi_scores.rds")
path_to_confounders_df <- here::here("scATAC-seq/2-QC/5-batch_effect_correction/2-data_integration_multiome/tmp/confounders_df.rds")
```
...
```{r}
confounders <- c("library_name", "sex", "age_group", "assay", "hospital")
plot_titles <- c("Library", "Sex", "Age group", "Assay", "Hospital")
