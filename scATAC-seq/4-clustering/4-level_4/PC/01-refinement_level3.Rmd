---
title: 'PC: scATAC annotation level 4'
...
print(paste("Number of PC from scRNA-seq multiome:", 
            sum(table(tonsil_RNA_annotation$annotation_level_5)))) 
```
...
```{r}
DimPlot(seurat, 
        group.by = "scrublet_predicted_doublet_atac")
