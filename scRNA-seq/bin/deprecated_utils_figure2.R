...
# PATHS
path_to_rna <- "~/Google Drive/My Drive/single_cell/PhD/B_cell_atlas/tonsil_atlas/tonsil_atlas_annotation/current/preprint/CD4_T/CD4_T_subseted_annotated_level_5.rds"
...
goi_cite <- c(
  naive_central_memory = c("CD49f", "CD62L", "CD127-(IL-7Ralpha)", "CD45RA"),
  tfh = c("CD45RO", "CD279-(PD-1)", "CD278-(ICOS)", "TIGIT-(VSTM3)"),
  teff = c("CD161", "CD28.1", "CD95-(Fas)", "CD39"),
  treg = c("CD25", "CD71")
)
goi_th <- c("IL7R", "TBX21", "CXCR3", "GZMK", "IFNG", "RORC", "IL17F",
            "IL17A", "IL26", "CCR6", "GATA3", "CCR4", "IRF4", "IL22",
            "TGFBR2", "SELL", "LEF1", "PRDM1")
goi_spatial <- list(
