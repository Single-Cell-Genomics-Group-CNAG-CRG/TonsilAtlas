...
```{r}
# Paths
path_to_obj <- here::here("scRNA-seq/results/R_objects/level_3/GCBC/GCBC_annotated_level_3.rds")
path_to_obj_level_2 <- here::here("scRNA-seq/results/R_objects/level_2/GCBC/GCBC_clustered_level_2.rds")
path_to_level_4 <- here::here("scRNA-seq/results/R_objects/level_4/GCBC/")
dir.create(path_to_level_4, recursive = TRUE, showWarnings = FALSE)
path_to_save <- str_c(path_to_level_4, "GCBC_subsetted_level_4.rds")
...
# Load level 2
seurat_level_2 <- readRDS(path_to_obj_level_2)
preMBC <- subset(seurat_level_2, idents = "3")
DimPlot(preMBC, cols = color_palette, pt.size = 0.2)
```
...
# Merge potential cluster of precursor MBC (preMBC)

```{r}
preMBC$annotation_level_3 <- "preMBC_or_technical"
seurat <- merge(x = seurat, y = preMBC)
