...
# Define paths
path_to_obj <- here::here("scRNA-seq/results/R_objects/tonsil_rna_integrated_annotated_level_1.rds")
path_to_save <- here::here("scRNA-seq/results/R_objects/level_2/")
