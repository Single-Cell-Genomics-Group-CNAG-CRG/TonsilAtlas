---
title: "Merge scATAC-seq objects (102)"
...
Here we will [merge](https://satijalab.org/signac/articles/merging.html) the scATAC-seq objects for case 102.
...
```{r}
path_to_data <- here::here("MCL/results/R_objects/1.seurat_objects_atac_filtered_102.rds")
path_to_save <- here::here("MCL/results/R_objects/2.seurat_merged_atac_102.rds")
```
...
```{r}
seurat <- merge(
  x = seurat_list_unified$kpi1zxjo_542l3n1f,
  y = list(seurat_list_unified$poba5cxi_qte0l4uh, seurat_list_unified$rvnas5hf_wfkqdmhy)
)
