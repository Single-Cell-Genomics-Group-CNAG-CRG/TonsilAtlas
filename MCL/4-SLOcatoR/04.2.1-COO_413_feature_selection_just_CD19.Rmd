---
title: "Cell-of-origin prediction: Feature Selection (413)- JUST CD19"
...
path_to_save <- here::here("MCL/results/R_objects/7.merged_tumoral_reference_query_413_CD19.rds")
path_to_save_query <- here::here("MCL/results/R_objects/7.merged_tumoral_reference_query_413_CD19.rds")
...
HERE WE WILL SUBSET TO JUST CD19+

```{r}
query <- subset(query, library_name == "M413pos_GEX")
```
