...
# donor_id=${id_dict[${id}]}
# R -e "rmarkdown::render('03-clustering.Rmd',
#                         params = list( 
#                           sample_id = '$id',
#                           donor_id = '$donor_id'),
#                         output_file='03-clustering_${donor_id}.html')"
# done

R -e "rmarkdown::render('03-clustering_integration.Rmd',
                        output_file='03-clustering_integration.html')"
