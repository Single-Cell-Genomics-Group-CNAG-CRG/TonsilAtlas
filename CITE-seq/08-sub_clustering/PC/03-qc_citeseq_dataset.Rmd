...
path_to_seurat_wnn_citeseq_obj <- "objects/seurat_object_cite_seq_pc_positive_object.rds"
...
colnames(annotated_cells) <- c("PC_annotation_level_5","PC_annotation_probability", "PC_UMAP1", "PC_UMAP2")
```
...
seurat_wnn_citeseq@meta.data %>%
  ggplot(aes(PC_UMAP1, PC_UMAP2, color = PC_annotation_level_5)) +
...
df = count(metadata,metadata$PC_annotation_level_5)
...
with(df, table(PC_annotation_level_5, repertoire_flag, useNA = "ifany"))
```
