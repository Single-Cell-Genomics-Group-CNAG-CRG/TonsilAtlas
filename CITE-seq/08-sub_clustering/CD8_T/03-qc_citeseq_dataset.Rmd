...
```{r}
# Paths
path_to_annotated_citeseq_cells <- "objects/umap_df_cite_seq.rds"
path_to_seurat_wnn_citeseq_obj <- "objects/seurat_object_cite_seq_cd8_positive_object.rds"
path_to_save_annotated_citeseq <- "objects/CD8_tonsil_cite_seq_annotated.rds"
...
colnames(annotated_cells) <- c("CD8_annotation_level_5","CD8_annotation_probability", "CD8_UMAP1", "CD8_UMAP2")
```
...
seurat_wnn_citeseq@meta.data %>%
  ggplot(aes(CD8_UMAP1, CD8_UMAP2, color = CD8_annotation_level_5)) +
...
df = count(metadata,metadata$CD8_annotation_level_5)
...
with(df, table(CD8_annotation_level_5, repertoire_flag, useNA = "ifany"))
```
