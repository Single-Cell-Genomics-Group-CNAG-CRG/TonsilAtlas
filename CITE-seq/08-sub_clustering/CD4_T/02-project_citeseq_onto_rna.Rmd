---
title: "Project CD4 CITE-seq onto RNA-seq (level 5)"
...
# Paths
path_to_query <- "objects/seurat_object_cite_seq_cd4_positive_object.rds"
path_to_reference <- "objects/CD4_T_subseted_annotated_level_5.rds"
path_to_save_cite_seq_df <- "objects/umap_df_cite_seq.tsv"
path_to_save_integrated <- "objects/CD4_T_cell_integrated_cite_seq_rna.rds"
```
...
reference@meta.data$annotation_level_5 <- reference@meta.data$annotation_paper
