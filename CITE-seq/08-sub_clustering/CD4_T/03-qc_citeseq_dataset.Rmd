...
path_to_seurat_wnn_citeseq_obj <- "objects/seurat_object_cite_seq_cd4_positive_object.rds"
path_to_save_annotated_citeseq <- "objects/CD4_tonsil_cite_seq_annotated.rds"
...
colnames(annotated_cells) <- c("CD4_annotation_level_5","CD4_annotation_probability", "CD4_UMAP1", "CD4_UMAP2")
```
...
seurat_wnn_citeseq@meta.data %>%
  ggplot(aes(CD4_UMAP1, CD4_UMAP2, color = CD4_annotation_level_5)) +
...
df = count(metadata,metadata$CD4_annotation_level_5)
...
with(df, table(CD4_annotation_level_5, repertoire_flag, useNA = "ifany"))
```
