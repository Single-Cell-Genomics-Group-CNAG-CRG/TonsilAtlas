---
title: "Project GCBC CITE-seq onto RNA-seq (level 5)"
...
# Paths
path_to_query <- "objects/seurat_object_cite_seq_gcbc_positive_object.rds"
path_to_reference <- "objects/GCBC_seu_obj_level_5_beta.rds"
path_to_save_cite_seq_df <- "objects/umap_df_cite_seq.tsv"
path_to_save_integrated <- "objects/GCBC_B_cell_integrated_cite_seq_rna.rds"
```
...
reference@meta.data$annotation_level_5 <- reference@meta.data$names_level_5_clusters_beta
